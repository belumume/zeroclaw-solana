...
BEATS = [
    ...
    Beat(
        "injection-certify",
        "python scripts/certify_publish_tx.py",
        # From the real run: one positive control then seven injection shapes, each REFUSED with its
        # reason, closing "8/8 cases correct". "fail-closed" is in the header line.
        ["fail-closed", "REFUSED", "cases correct"],
        0.12,
        "The fail-closed suite: one good publish certifies, seven injection shapes refuse, each "
